...
export const api = {
  ...
  importSpreadsheet: (body: unknown) => request<{ parsedRows: number; importedPlantings: number; skippedRows: number }>("/api/import/spreadsheet", { method: "POST", body: JSON.stringify(body) }),
