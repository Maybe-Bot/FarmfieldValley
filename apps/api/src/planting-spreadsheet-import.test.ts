...
test("importPlantingSpreadsheetRowsForFarm imports full backup sheets by exported ids", async () => {
  ...
  const rows = [
    ...
    ...sheetRows("Task Flow Nodes", ["id", "flowTemplateId", "nodeKey", "taskType", "label", "anchor", "offsetDays", "x", "y", "tractorModel", "tractorProfileId", "notes"], [
      { id: "811", flowTemplateId: "801", nodeKey: "seed", taskType: "tray_seeding", label: "Seed trays", anchor: "sow", offsetDays: "0", x: "0.2", y: "0.3", tractorProfileId: "701" },
      { id: "812", flowTemplateId: "801", nodeKey: "transplant", taskType: "transplant", label: "Transplant", anchor: "transplant", offsetDays: "0", x: "0.6", y: "0.5", tractorProfileId: "701" }
    ]),
    ...
    ...sheetRows("Tasks", ["id", "plantingId", "bedId", "taskFlowNodeId", "taskType", "title", "status", "anchor", "offsetDays", "dependsOnTaskIds", "scheduledDate", "completedDate", "isAutoGenerated", "tractorModel", "tractorProfileId", "notes"], [
      { id: "1101", plantingId: "901", bedId: "301", taskFlowNodeId: "811", taskType: "tray_seeding", title: "Seed Kale", status: "pending", anchor: "sow", offsetDays: "0", scheduledDate: "2026-03-01", isAutoGenerated: "TRUE", tractorProfileId: "701" },
      { id: "1102", plantingId: "901", bedId: "301", taskFlowNodeId: "812", taskType: "transplant", title: "Transplant Kale", status: "pending", anchor: "transplant", offsetDays: "0", dependsOnTaskIds: "1101", scheduledDate: "2026-04-10", isAutoGenerated: "TRUE", tractorProfileId: "701" }
    ]),
